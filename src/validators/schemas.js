...
const payPurchaseBody = z.object({
  ...
  paymentMethod: z.enum(["cash", "card", "mercadopago", "transfer", "naranja_x", "uala", "brubank", "santander", "supervielle", "frances", "bna", "prex", "cocos", "galicia", "lemon", "astropay", "modo", "check", "other"]),
